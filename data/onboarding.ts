...
export const PLACEMENT_ANCHORS: PlacementAnchor[] = [
  ...
  { categoryId: 'pushpull', exercise: 'Push-ups', unit: 'incline OK at L1', thresholds: [{ level: 1, label: '3' }, { level: 2, label: '5' }, { level: 3, label: '8' }, { level: 4, label: '12' }, { level: 5, label: '20' }] },
