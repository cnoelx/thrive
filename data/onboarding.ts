...
export const PLACEMENT_ANCHORS: PlacementAnchor[] = [
  ...
  { categoryId: 'pull', exercise: 'Pulling', thresholds: [{ level: 1, label: 'Active hang 15s' }, { level: 2, label: 'Scapular pulls ×5' }, { level: 3, label: 'Negatives ×3 (jump to top, lower 5s)' }, { level: 4, label: '5 with a band' }, { level: 5, label: '1 pull-up' }] },
  ...
  { categoryId: 'mobility', exercise: 'Deep squat hold', thresholds: [{ level: 1, label: 'With support 15s' }, { level: 2, label: 'With support 30s' }, { level: 3, label: 'No support 30s' }, { level: 4, label: 'No support 60s' }, { level: 5, label: 'No support 90s' }] },
];
