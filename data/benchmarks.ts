...
const EXERCISES: Exercise[] = [
  ...
  { key: "pushups", categoryId: "push", name: "Push-ups", why: "Push, catch a fall", sets: 2, targets: ["wall ×8", "incline ×8 (hands on a counter)", "incline ×8 (hands on a low step)", "negatives ×5 (lower down slowly)", "5 full push-ups", "8 full push-ups", "feet-elevated ×8", "diamond ×8", "archer ×5/side", "one-arm progression ×3/side"] },
  ...
  { key: "pullup", categoryId: "pull", name: "Pulling", why: "Pull your bodyweight up — hang, then pull (needs bar or rings)", sets: 2, targets: ["active hang 15s", "scapular pulls ×5", "negatives ×3 (jump to the top, lower for 5s)", "5 with a band", "1 pull-up", "3 pull-ups", "6 pull-ups", "chest-to-bar ×5", "archer ×3/side", "one-arm progression / weighted"] },
