...
const EXERCISES: Exercise[] = [
  ...
  { key: "pullup", categoryId: "pull", name: "Pulling", why: "Pull your bodyweight up — hang, then pull (needs bar or rings)", sets: 3, targets: ["active hang 15s", "scapular pulls ×5", "negatives ×3 (jump to the top, lower for 5s)", "5 with a band", "3 pull-ups", "6 pull-ups", "10 pull-ups", "chest-to-bar ×5", "archer ×3/side", "one-arm progression / weighted"] },
