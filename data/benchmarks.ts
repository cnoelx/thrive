...
const EXERCISES: Exercise[] = [
  ...
  { key: "pushups", categoryId: "push", name: "Push-ups", why: "Push, catch a fall", sets: 3, targets: ["wall ×8", "hands on a counter ×8", "hands on a low step ×8", "lower down slowly ×5", "8 full push-ups", "diamond ×8", "feet-elevated ×8", "archer ×5/side", "pseudo-planche ×6", "one-arm progression ×3/side"] },
