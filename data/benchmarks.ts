...
const EXERCISES: Exercise[] = [
  ...
  { key: "sideplank", categoryId: "move", name: "Side Plank", why: "Lateral/anti-rotation core", sets: 3, targets: ["knee 10s/side", "knee 20s/side", "full 30s/side", "full 45s/side", "full 60s/side", "full 75s/side", "star side plank 20s", "+reach-through ×10", "single-leg side plank 20s"] },
  { key: "glutebridge", categoryId: "move", name: "Glute Bridge", why: "Posterior chain (main)", sets: 3, targets: ["10", "16", "24", "34", "single-leg 12/leg", "single-leg ×12/leg", "feet-elevated SL ×10/leg", "marching hold 30s", "hip thrust (load) ×12", "single-leg hip thrust ×8/leg"] },
  { key: "pronelegraise", categoryId: "move", name: "Prone Leg Raise", why: "Posterior chain (glutes/hamstrings)", sets: 2, targets: ["6/leg", "10/leg", "15/leg", "20/leg", "20/leg + 2s hold", "both legs + hold ×12", "swimmer flutter 30s", "+light ankle load ×12", "superman rock 30s"] },
  { key: "pushups", categoryId: "push", name: "Push-ups", why: "Push, catch a fall", sets: 3, targets: ["wall ×8", "high incline ×8", "low incline ×8", "negatives ×5", "8 strict", "diamond ×8", "feet-elevated ×8", "archer ×5/side", "pseudo-planche ×6", "one-arm progression ×3/side"] },
  { key: "barrow", categoryId: "pull", name: "Inverted Row", why: "Horizontal pull (rings/TRX, or bar set low). Angle = difficulty.", sets: 3, targets: ["upright, 5 reps", "upright, 8 reps", "leaned back, 10 reps", "leaned back, 12 reps", "near-horizontal, 12-15 reps", "feet-elevated ×10", "tuck front-lever hold 8s", "wide front-lever tuck 10s", "one-arm row progression ×5/side", "advanced lever hold 12s"] },
  { key: "deadhang", categoryId: "pull", name: "Dead Hang", why: "Grip strength (needs bar or rings)", sets: 3, targets: ["active 8s", "15s", "25s", "35s", "45s", "60s", "90s", "one-arm assisted 10s/side", "towel/thick-grip 30s", "one-arm hang progression 8s/side"] },
  { key: "pullup", categoryId: "pull", name: "Pull-up Progression", why: "Pull bodyweight up (needs bar or rings)", sets: 3, targets: ["scap pulls ×5", "negative 5s ×3", "negative 10s ×3", "band-assisted ×5", "3–5 strict", "6 strict", "10 strict", "chest-to-bar ×5", "archer ×3/side", "one-arm progression / weighted"] },
