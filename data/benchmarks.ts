...
const EXERCISES: Exercise[] = [
  ...
  { key: "pullup", categoryId: "pull", name: "Pulling", why: "Pull your bodyweight up — hang, then pull (needs bar or rings)", sets: 3, targets: ["active hang 15s → scap pulls ×5", "negative 5s ×3", "negative 10s ×3", "band-assisted ×5", "3–5 strict", "6 strict", "10 strict", "chest-to-bar ×5", "archer ×3/side", "one-arm progression / weighted"] },
