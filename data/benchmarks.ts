...
const EXERCISES: Exercise[] = [
  { key: "squat", categoryId: "move", name: "Bodyweight Squat", why: "Stand, sit, lower all day", sets: 2, targets: ["15", "22", "30", "40", "50", "tempo (4s lower) ×8", "paused (3s bottom) ×8", "split squat ×8/leg", "Bulgarian split ×6/leg", "pistol progression ×3/leg"] },
  { key: "lunge", categoryId: "move", name: "Reverse Lunge", why: "Stairs, single-leg strength (per leg)", sets: 2, targets: ["10 (5/leg)", "16 (8/leg)", "24 (12/leg)", "32 (16/leg)", "40 (20/leg)", "walking ×12/leg", "deficit ×8/leg", "Bulgarian split ×8/leg", "jumping lunge ×6/leg", "pistol progression ×3/leg"] },
  ...
  { key: "plank", categoryId: "move", name: "Plank", why: "Stable trunk, protects back", sets: 2, targets: ["20s", "35s", "50s", "70s", "90s", "120s", "RKC tension 30s", "single-arm 20s", "single-arm+leg 15s"] },
  { key: "sideplank", categoryId: "move", name: "Side Plank", why: "Side core — resists twisting", sets: 2, targets: ["knee 10s/side", "knee 20s/side", "full 30s/side", "full 45s/side", "full 60s/side", "full 75s/side", "star side plank 20s", "+reach-through ×10", "single-leg side plank 20s"] },
  { key: "glutebridge", categoryId: "move", name: "Glute Bridge", why: "Glutes & hamstrings (backside)", sets: 2, targets: ["10", "16", "24", "34", "single-leg ×8/leg", "single-leg ×12/leg", "feet-elevated SL ×10/leg", "marching hold 30s", "hip thrust (load) ×12", "single-leg hip thrust ×8/leg"] },
  ...
  { key: "pushups", categoryId: "push", name: "Push-ups", why: "Push, catch a fall", sets: 2, targets: ["wall ×8", "high incline ×8 (hands on a counter)", "low incline ×8 (hands on a low step)", "negatives ×5 (lower down slowly)", "5 full push-ups", "8 full push-ups", "feet-elevated ×8", "diamond ×8", "archer ×5/side", "one-arm progression ×3/side"] },
  { key: "barrow", categoryId: "pull", name: "Inverted Row", why: "Horizontal pull (rings/TRX, or bar set low). Angle = difficulty.", sets: 2, targets: ["upright, 5 reps", "upright, 8 reps", "leaned back, 10 reps", "leaned back, 12 reps", "near-horizontal, 12 reps", "feet-elevated ×10", "tuck front-lever raises ×5", "tuck front-lever hold 8s", "wide front-lever tuck 10s", "one-arm row progression ×5/side"] },
  { key: "pullup", categoryId: "pull", name: "Pulling", why: "Pull your bodyweight up — hang, then pull (needs bar or rings)", sets: 2, targets: ["active hang 15s", "scapular pulls ×5", "negatives ×3 (jump to the top, lower for 5s)", "5 with a band", "1 pull-up", "3 pull-ups", "6 pull-ups", "10 pull-ups", "archer ×3/side", "one-arm progression / weighted"] },
  { key: "walkrun", categoryId: "cardio", name: "Walk / Run (walk-first)", why: "Cover distance without gassing out", sets: null, targets: ["brisk walk 10min", "brisk walk 20min", "brisk walk 30min", "walk-jog 20min", "easy jog 20min", "jog 30min", "jog 5km easy", "jog 8km / 45min easy", "jog 10km / sustained"] },
