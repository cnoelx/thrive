...
const EXERCISES: Exercise[] = [
  ...
  { key: "glutebridge", categoryId: "move", name: "Glute Bridge", why: "Glutes & hamstrings (backside)", sets: 3, targets: ["10", "16", "24", "34", "single-leg ×8/leg", "single-leg ×12/leg", "feet-elevated SL ×10/leg", "marching hold 30s", "hip thrust (load) ×12", "single-leg hip thrust ×8/leg"] },
  ...
  { key: "pullup", categoryId: "pull", name: "Pulling", why: "Pull your bodyweight up — hang, then pull (needs bar or rings)", sets: 3, targets: ["active hang 15s", "scapular pulls ×5", "negatives ×3 (jump to the top, lower for 5s)", "5 with a band", "1 pull-up", "3 pull-ups", "6 pull-ups", "chest-to-bar ×5", "archer ×3/side", "one-arm progression / weighted"] },
